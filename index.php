      ...
      <div class="navbar navbar-expand-lg landing-navbar border-top-0 px-3 px-md-4">
        ...
        <div class="navbar-brand app-brand demo d-flex py-0 py-lg-2 me-4">
          ...
          <a href="landing-page.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2 ps-1">Materio</span>
          </a>
        </div>
          ...
          <div class="row gx-0 gy-4 g-md-5">
            <div class="col-lg-5">
              <a href="landing-page.html" class="app-brand-link mb-4">
                ...
                <span class="app-brand-text demo footer-link fw-bold">Materio</span>
              </a>
      ...
      <div class="footer-bottom py-3">
        <div
          ...
          <div class="mb-2 mb-md-0">
            ...
            <a href="https://themeselection.com" target="_blank" class="footer-link fw-medium footer-theme-link"
              >ThemeSelection</a
            >
          </div>
          <div>
            <a href="https://github.com/themeselection" class="footer-link me-2" target="_blank"
              ><i class="mdi mdi-github"></i
            ></a>
            <a href="https://www.facebook.com/ThemeSelections/" class="footer-link me-2" target="_blank"
              ><i class="mdi mdi-facebook"></i
            ></a>
            <a href="https://twitter.com/Theme_Selection" class="footer-link me-2" target="_blank"
