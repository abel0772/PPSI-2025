...
<html
  ...
  <head>
    ...
    <title>DataTables - Tables | Materio - Bootstrap Material Design Admin Template</title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="../user_group/index.php" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-table"></i>
                <div data-i18n="Tables">User Group</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="../transaction/index.php" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-table"></i>
                <div data-i18n="Tables">Transaction</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="../tenant/index.php" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-table"></i>
                <div data-i18n="Tables">Event</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="../payment_method/index.php" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-table"></i>
                <div data-i18n="Tables">Payment Method</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="../location/index.php" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-table"></i>
                <div data-i18n="Tables">Location</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="../artist/index.php" class="menu-link">
                <i class="menu-icon tf-icons mdi mdi-table"></i>
